...
int	render(t_mlx_data *data)
{
    ...
    render_mandelbrot(&data->img, (t_mandelbrot){-2 / data->img.scale - data->img.offset_x / 100, 1 / data->img.scale + data->img.offset_y / 100, W * data->img.scale, H * data->img.scale});
