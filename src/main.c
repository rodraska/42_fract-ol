...
int	render(t_mlx_data *data)
{
	...
	//render_rect(&data->img, (t_rect){W - 50 + data->img.offset_x, H / 2 + data->img.offset_y, 100, 100, GREEN});
    render_circle(&data->img, (t_circle){W / 2 + data->img.offset_x, H / 2 + data->img.offset_y, 200, BLUE});
